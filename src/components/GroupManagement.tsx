  ...
  return (
    <div className="space-y-6">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full mx-4">
            <h3 className="text-xl font-bold mb-4">
              {selectedGroup ? 'تعديل الفوج' : 'إضافة فوج جديد'}
            </h3>
            ...
            <div className="flex justify-end gap-3 mt-6">
              ...
              >
                {selectedGroup ? 'حفظ التغييرات' : 'إضافة الفوج'}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full mx-4">
            <div className="flex items-center gap-3 text-red-600 mb-4">
              ...
              <h3 className="text-xl font-bold">تأكيد حذف الفوج</h3>
            </div>
            <p className="text-gray-600 mb-6">
              هل أنت متأكد من حذف الفوج {selectedGroup.name}؟ هذا الإجراء لا يمكن التراجع عنه.
            </p>
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-gray-800">إدارة الأفواج</h1>
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold">قائمة الأفواج</h2>
              </div>
            </div>
        ...
        <div className="p-6">
          ...
          {filteredGroups.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-500">لا توجد أفواج مطابقة للبحث</h3>
            </div>
          )}
        </div>
      </div>
